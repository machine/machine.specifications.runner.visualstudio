...
namespace Machine.Specifications.Runner.VisualStudio.Helpers
{
    ...
    public class VisualStudioTestIdentifier
    {
        ...
        public string FieldName => FullyQualifiedName.Split(new[] { "::" }, StringSplitOptions.RemoveEmptyEntries)[1];

        public string ContainerTypeFullName => FullyQualifiedName.Split(new[] { "::" }, StringSplitOptions.RemoveEmptyEntries)[0];
